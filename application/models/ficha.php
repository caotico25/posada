...
class Ficha extends CI_Model
{
    ...
    {
        $res = $this->db->query("select * from tablas_ficha where ficha = $ficha_base order by id");
    ...
    {
        $res = $this->db->query("select * from $tabla where ficha = $ficha_base order by id, subcategoria");
