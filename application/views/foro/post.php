<div id="migas">
    <a href="<?= base_url('portal/inicio') ?>">Inicio</a> <span>></span> <a href="<?= base_url('foro/foros') ?>">Foro</a> <span>></span> <a href="<?= base_url('foro/temas') . '/index/' . $post['tema'] ?>"><?= nombre_tema($post['tema']) ?></a> <span>></span> <?= $post['titulo'] ?>
</div>
<section>
    <h2><?= $post['titulo'] ?></h2>
    <article class="post">
